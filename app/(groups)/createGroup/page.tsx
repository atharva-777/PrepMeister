...
const CreateGroup = () => {
    return (
      <section className="pt-24 p-8">
        <div>Create your own chat sessions to interact with peer learners</div>
        <div className="text-center m-4 p-6 space-y-5 border border-spacing-2 border-solid">
          ...
          <button className="bg-blue-400 p-3 rounded-md hover:bg-blue-600">
            Create Group
          </button>
        </div>
        <div className="m-4 p-6 bg-blue-300 rounded-md">
          <p>
            Group ID :
            <span className="m-2 p-2">
              ID is displayed upon creating group
            </span>
          </p>
        </div>
      </section>
